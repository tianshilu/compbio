...
for line in open ('/home2/s171162/work/compbio/lab1/sample_data/sample.fasta'):
...
result_file=file ('/home2/s171162/work/compbio/lab1/sample_data/sample_unitig2.txt','w')
...
while rlist!=[]:
    ...
    order[0].append(0)
    tlist.append('%s\t%02d\t%i\t%i'%('UNI',f,len(olist),len(unitig)))
